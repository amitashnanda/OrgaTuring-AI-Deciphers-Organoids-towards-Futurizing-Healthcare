...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["Interactive GUI, Web API, Open Source, User Friendly", "Quantification/Segmentation/Classification of Organoids", "Edge AI Smart Medical Device For Real-Time Investigation"],    /* You can change the home section typing text from
